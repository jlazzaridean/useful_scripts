...
def parse_picoharp_t3_frame(
    ...
    sin_corr_value=80 # the only value the header knows how to set. maybe it's the scan rate / 10?
    ):
...
if __name__ == '__main__':
    ...
    tf.imwrite('tester_output.tif', im[:, :, :, :])
